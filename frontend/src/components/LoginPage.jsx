...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      setToast({
        show: true,
        message: result.message || 'Login successful! Redirecting to dashboard...',
        type: 'success'
      })
      setLoading(false)
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-white flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-2xl shadow-black/5 p-8 md:p-10 border border-gray-100/50 backdrop-blur-sm">
          ...
          <button
            onClick={() => navigate('/')}
            className="mb-6 flex items-center text-gray-500 hover:text-black transition-colors group"
          >
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-500 text-sm">
              Login to your account and continue organizing your tasks
            </p>
          </div>
